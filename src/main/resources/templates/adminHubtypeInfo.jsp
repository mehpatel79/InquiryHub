...
<table class="table center" style="padding:30px; margin:30px;">
  ...
  <tbody class="table-group-divider table-hover table-striped">
	...
	<tr th:each="ht : ${htList}">
		<td th:text="${ht.id}"></td>
        <td th:text="${ht.hubTypeName}"></td>
        <td></td>
	</tr> 
	
	<form method="post" action="addHubtype">
	<tr>
		<td>	</td>
		<td>  <input class="input-field" type="text" placeholder="Hub Type Name" name="hubTypeName"></td>
