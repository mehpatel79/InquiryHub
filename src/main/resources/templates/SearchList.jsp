	...
	<div>
		...
		<h5>IT Training Institute</h5>
    		...
    		<li style="margin-left:30px">
				...
				<a style="font-size:20px" th:href="@{/SignUp}" th:text="${ac1.associateName}"  ></a>
	...
	<div>
		<h5>Car Dealer </h5>
    		...
    		<li style="margin-left:30px">
				...
				<a style="font-size:20px" th:href="@{/SignUp}" th:text="${ac2.associateName}"  ></a>
			</li>
    	</tr>
    </div>
	...
	<div>
		<h5>Bike Dealer </h5>
    		...
    		<li style="margin-left:30px">
				...
				<a style="font-size:20px" th:href="@{/SignUp}" th:text="${ac3.associateName}"  ></a>
			</li>
    	</tr>
    </div>
	...
	<div>
		<h5>Car Service </h5>
    		...
    		<li style="margin-left:30px">
				...
				<a style="font-size:20px" th:href="@{/SignUp}" th:text="${ac4.associateName}"  ></a>
			</li>
    	</tr>
    </div>
    <br> 
	<div>
		<h5>Bike Service </h5>
    		...
    		<li style="margin-left:30px">
				...
				<a style="font-size:20px" th:href="@{/SignUp}" th:text="${ac5.associateName}"  ></a>
			</li>
    	</tr>
    </div>
    <br> 
	<div>
		<h5>Electronics Goods Dealer </h5>
    		...
    		<li style="margin-left:30px">
				...
				<a style="font-size:20px" th:href="@{/SignUp}" th:text="${ac6.associateName}"  ></a>
			</li>
    	</tr>
    </div>
