...
<body>
   	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
         ...
         <div style="padding:5px; top-height:5px">
             <div style="color:Violet; padding:5px;"><center><h2><tr th:each="user : ${userList}">Welcome,  <span th:text="${user.userName}"></h2></center></span>
    	 </div>
...
<table class="table center" style="padding:30px; margin:30px;">
  ...
  <tbody class="table-group-divider table-hover table-striped">
	...
	<tr th:each="inquiry : ${inquiryList}">
        ...
        <td th:text="${inquiry.user.userName}"></td> <!-- th:text="${inquiry.user.userName}" -->
